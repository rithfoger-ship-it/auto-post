...
TOKEN = "8668472117:AAE_v84w8w8WBtDMzgS66z0yqOFK8-kCRls"
...
async def process_single_link(update: Update, url: str):
    ...
    try:
        ...
        if data.get("code") == 0:
            ...
            # ករណីទី ១៖ ប្រសិនបើជា Slideshow (มีรูปภาพหลายសន្លឹក)
            if images:
            ...
            # ករណីទី ២៖ ប្រសិនបើជាវីដេអូធម្មតា (Video)
                ...
                await update.message.reply_text("❌ មិនអាចរកឃើញមាតិកា (រូបភាព ឬវីដេអូ) ពី Link นี้ได้ទេ។")
        else:
